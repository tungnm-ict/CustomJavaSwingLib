...
public class Theme {
     ...
     *
     */
    public static final int CUSTOMER_STANDARD_BUTTON_THEME = 1001;
    public static final int CUSTOMER_STANDARD_SELECTED_BUTTON_THEME = 1002;
    public static final int CUSTOMER_STANDARD_ROLLOVER_BUTTON_THEME = 1003;
    
    public static final int CUSTOMER_GRADIENT_BUTTON_THEME = 2001;
    public static final int CUSTOMER_GRADIENT_SELECTED_BUTTON_THEME = 2002;
    public static final int CUSTOMER_GRADIENT_ROLLOVER_BUTTON_THEME = 2003;
    
    public static final int CUSTOMER_GLOSSY_BUTTON_THEME = 1001;
    public static final int CUSTOMER_GLOSSY_SELECTED_BUTTON_HEME = 1002;
    public static final int CUSTOMER_GLOSSY_ROLLOVER_BUTTON_THEME = 1003;
    ...
    public static final int STANDARD_LIGHTGRAY204_THEME = 221204;
    public static final int STANDARD_LIGHTGRAY214_THEME = 221214;
