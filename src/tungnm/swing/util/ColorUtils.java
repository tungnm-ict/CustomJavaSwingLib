...
import tungnm.swing.component.button.GradientButton;
...
public class ColorUtils {
    ...
    public GradientPaint getStandardColor(int theme, int height, JButton button) {
        switch (theme) {
            case Theme.CUSTOMER_STANDARD_BUTTON_THEME:
                buttonColor = new GradientPaint(0, 0, StandardButton.BUTTON_COLOR, 0,
                        3 * height / 4, StandardButton.BUTTON_COLOR);
                //button.setForeground(Color.WHITE);
                break;
            case Theme.CUSTOMER_STANDARD_SELECTED_BUTTON_THEME:
                buttonColor = new GradientPaint(0, 0, StandardButton.SELECTED_BUTTON_COLOR, 0,
                        3 * height / 4, StandardButton.SELECTED_BUTTON_COLOR);
                //button.setForeground(Color.WHITE);
                break;
            case Theme.CUSTOMER_STANDARD_ROLLOVER_BUTTON_THEME:
                buttonColor = new GradientPaint(0, 0, StandardButton.ROLLOVER_BUTTON_COLOR, 0,
                        3 * height / 4, StandardButton.ROLLOVER_BUTTON_COLOR);
                //button.setForeground(Color.WHITE);
                break;
            ...
            case Theme.STANDARD_BLACK_THEME:
                buttonColor = new GradientPaint(0, 0, new Color(50, 50, 50), 0,
                        height, new Color(40, 40, 40));
                //button.setForeground(Color.WHITE);
            ...
            case Theme.STANDARD_LIGHTGRAY_THEME:
                ...
                break;
            case Theme.STANDARD_LIGHTGRAY204_THEME:
                buttonColor = new GradientPaint(0, 0, new Color(204, 204, 204), 0,
                        height, new Color(204, 204, 204));
            //button.setForeground(Color.WHITE);
            case Theme.STANDARD_LIGHTGRAY214_THEME:
                buttonColor = new GradientPaint(0, 0, new Color(214, 214, 214), 0,
                        height, new Color(214, 214, 214));
                //button.setForeground(Color.WHITE);
                break;
    ...
    public GradientPaint getGradientColor(int theme, int height,
            JComponent button) {
        switch (theme) {
            case Theme.CUSTOMER_GRADIENT_BUTTON_THEME:
                gradientBtnColor = new GradientPaint(0, 0,
                        GradientButton.BUTTON_COLOR, 0, height, GradientButton.BUTTON_COLOR);
                //button.setForeground(Color.WHITE);
                break;
            case Theme.CUSTOMER_GLOSSY_SELECTED_BUTTON_HEME:
                gradientBtnColor = new GradientPaint(0, 0,
                        GradientButton.SELECTED_BUTTON_COLOR, 0, height, GradientButton.SELECTED_BUTTON_COLOR);
                //button.setForeground(Color.WHITE);
                break;
            case Theme.CUSTOMER_GRADIENT_ROLLOVER_BUTTON_THEME:
                gradientBtnColor = new GradientPaint(0, 0,
                        GradientButton.ROLLOVER_BUTTON_COLOR, 0, height, GradientButton.ROLLOVER_BUTTON_COLOR);
                //button.setForeground(Color.WHITE);
                break;
