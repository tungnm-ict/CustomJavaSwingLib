 ...
 *
 */
package tungnm.swing.component.button;
...
import tungnm.swing.util.ColorUtils;
...
public class GradientButton extends JButton {
    ...
    public static Color BUTTON_COLOR=Color.BLACK;
    public static Color SELECTED_BUTTON_COLOR=Color.GRAY;
    public static Color ROLLOVER_BUTTON_COLOR=Color.LIGHT_GRAY;
     ...
     *
     * @param text label on the button
     * @param buttonTheme button theme.
     */
     ...
     * @param buttonType shape of the button
     * @param buttonTheme theme of the button
     * @param rolloverTheme roll-over theme
     */
     ...
     * @param shadowWidth width of shadow
     * @param clipShape shape
     */
     ...
     *
     * @param c1 Color
     * @param pct1 float value
     * @param c2 Color
     * @param pct2 float value
     * @return Color
     */
     ...
     *
     * @param selectedTheme theme when the button is selected
     */
